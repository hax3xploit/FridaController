...
Download the appropriate Frida server for your Android device from [Frida releases](https://github.com/frida/frida/releases).

Match your device architecture:
- ARM64: `frida-server-X.X.X-android-arm64`
- ARM: `frida-server-X.X.X-android-arm`
- x86: `frida-server-X.X.X-android-x86`

### 2. Install Frida Server on Android
...
You can rename the binary to avoid detection (e.g., `google-process`).
